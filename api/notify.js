    ...
    if (type === "task_assigned") {
      ...
      await sendEmail(email,
        ...
        `<div style="font-family:Arial,sans-serif;max-width:500px">
          ...
          <p><a href="${app_url || 'https://bioherencia-grants.vercel.app'}" style="background:#059669;color:white;padding:10px 20px;border-radius:8px;text-decoration:none;display:inline-block">Ver en plataforma →</a></p>
        </div>`
      );
